...
with col2:
    st.write(
        "Contact with [Pandorai](https://pandorai.ch/) to build your AI Projects")
...
def get_openai_api_key():
    input_text = st.text_input(
        label="OpenAI API Key ",  placeholder="Ex: sk-2twmA8tfCb8un4...", key="openai_api_key_input", type="password")
    return input_text
